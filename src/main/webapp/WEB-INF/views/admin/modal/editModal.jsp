...
<c:choose>
	...
	<c:otherwise>
		<span class="d-none" id="isUpdate">false</span>
	</c:otherwise>
</c:choose>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="card card-primary">
					<form:form action="" method="POST" modelAttribute="productEdit"
							...
							<div class="form-group">
								...
								<div class="input-group">
									<form:input path="productImage" type="file"
										accept=".jpg, .png, .jpeg|image/*" id="productImage" />
								</div>
							</div>
							<!-- Start Config -->
							<div class="form-group">
						...
						<div class="card-footer">
							<button id="btn-add-update" type="submit" class="btn btn-success">Save</button>
						</div>
					</form:form>
				</div>
			</div>
